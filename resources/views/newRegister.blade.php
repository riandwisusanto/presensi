		...
		<div class="wrapper-page">
			<div class=" card-box">
				<div class="panel-heading">
					<h3 class="text-center">Registrasi <strong class="text-custom">Bengkel Putra</strong> </h3>
				</div>
					...
					<form class="form-horizontal m-t-20" method="POST" action="{{ route('register') }}">
						...
						<div class="form-group text-center m-t-40">
							<div class="col-xs-12 text-center">
                                <div class="g-recaptcha " data-sitekey="6LeYfbgaAAAAABAC_RJXEn12T5jt49GBcd7EscOC"></div>
                                <br/>
                                @if(Session::has('g-recaptcha-response'))
                                    <p style="color:red;" class="alert {{Session::get('alert-class','alert-info')}}">
                                    {{Session::get('g-recaptcha-response')}}
                                    </p>
                                @endif
								<button style="background-color: #5fbeaa; color: white; " class="btn btn-block text-uppercase waves-effect waves-light" type="submit">
									Register
								</button>
							</div>
						</div>
			...
			<div class="row">
				<div class="col-sm-12 text-center">
					<p>
						Apakah sudah memiliki akun?<a href="/login" style="color: #5fbeaa;" class="text-success m-l-5"><b>Masuk</b></a>
					</p>
				</div>
			</div>
