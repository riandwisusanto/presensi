                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 pull-right">
                                            <a href="#" onclick="this.href='/presensi/laporan/cetak/'+ document.getElementById('tglawal').value +
                                        ...
                                        <div class="col-md-2 pull-right">
                                            <a href="/presensi/laporan/cetak" target="_blank" class="btn btn-primary btn-rounded btn-fw"><b><i class="fa fa-print"></i> Cetak Full PDF</a></b>
                                        </div>
                                    </div>
                                    <br> 
                                    <br>
...
<div class="card card-primary card-outline">
  <div class="card-body box-profile">
    ...
    <h3 class="profile-username text-center">Riwayat Absensi</h3>
